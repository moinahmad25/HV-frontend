...
const Profile = () => {
  ...
  useEffect(() => {
    ...
    const confirmedRooms = async () => {
      ...
      try {
        const response = await fetch(`https://hv-backend.onrender.com/api/user/get-confirmed-rooms`)
        const result = await response.json();
  ...
  useEffect(() => {
    const getImage = async () => {
      const response = await fetch(`https://hv-backend.onrender.com/api/form/get-image/${id}`)
      const result = await response.json();
      setImg(result);
    }
    getImage()
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch(
        `https://hv-backend.onrender.com/api/form/add-image/${id}`,
        {
          method: 'POST',
          body: formData,
        }
  ...
  const handleRoomSubmit = async () => {
    ...
    try {
      const response = await fetch(`https://hv-backend.onrender.com/api/user/${id}/pending-room-booking`, {
        method: 'POST',
        headers: {
  ...
  const handleUpload = async () => {
    ...
    try {
      const response = await fetch(
        `https://hv-backend.onrender.com/api/form/add-receipt/${id}`,
        {
          method: 'POST',
          body: formData,
        }
  ...
  const handleGatePassClick = async () => {
    setLoading(true)
    try {
      const response = await fetch(`https://hv-backend.onrender.com/api/form/apply-gate-pass/${id}`,
        {
          method: 'POST',
          headers: {
            'Content-Type': "application/json"
